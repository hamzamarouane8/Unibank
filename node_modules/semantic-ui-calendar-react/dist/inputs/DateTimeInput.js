  ...
  function DateTimeInput(props) {
    ...
    */
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSelect", function (e, _ref3) {
      ...
      (0, _lib.tick)(_this._handleSelectUndelayed, e, {
        value: value
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleSelectUndelayed", function (e, _ref4) {
      ...
      _this.setState(function (prevState) {
        ...
        if (mode !== 'minute') {
          ...
          var outValue = (0, _moment.default)(value).format(_this.getDateTimeFormat());
  ...
  _createClass(DateTimeInput, [{
    ...
    value: function getDateParams() {
      ...
      */
      ...
      if (!_lodash.default.isNil(year) || !_lodash.default.isNil(month) || !_lodash.default.isNil(date) || !_lodash.default.isNil(hour) || !_lodash.default.isNil(minute)) {
        return {
          year: year,
          month: month,
          date: date,
    ...
    value: function getDateTimeFormat() {
      ...
      return dateTimeFormat || "".concat(dateFormat).concat(divider).concat(_parse.TIME_FORMAT[timeFormat]);
    }
  }, {
    key: "getPicker",
    value: function getPicker() {
      ...
      if (mode === 'year') {
        return _react.default.createElement(_YearPicker.default, pickerProps);
      }

      if (mode === 'month') {
        return _react.default.createElement(_MonthPicker.default, pickerProps);
      }

      if (mode === 'day') {
        return _react.default.createElement(_DayPicker.default, pickerProps);
      }

      if (mode === 'hour') {
        return _react.default.createElement(_HourPicker.default, _extends({
          timeFormat: this.props.timeFormat
        }, pickerProps));
      }

      return _react.default.createElement(_MinutePicker.default, _extends({
        timeFormat: this.props.timeFormat
      }, pickerProps));
    }
  }, {
