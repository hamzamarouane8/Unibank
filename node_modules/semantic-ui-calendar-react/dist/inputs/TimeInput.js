  ...
  function TimeInput(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSelectUndelayed", function (e, _ref2) {
      ...
      _this.setState(function (prevState) {
        return {
          mode: getNextMode(prevState.mode)
        };
      });
    });
  ...
  _createClass(TimeInput, [{
    ...
    value: function getPicker() {
      ...
      var pickerProps = {
        ...
        timeFormat: timeFormat // key: value, // seems like it works without reinstantiating picker every time value changes
...
_defineProperty(TimeInput, "handledProps", ["closable", "timeFormat", "value"]);
